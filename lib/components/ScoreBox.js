		...
		value: function render() {
			...
			return _react2['default'].createElement(
				...
				_react2['default'].createElement(
					'div',
					{ style: [styles.score, { backgroundColor: _TeamsJson2['default'][this.props.home].color }] },
					this.props.content[0]
				),
				_react2['default'].createElement(
					'div',
					{ style: [styles.score, { backgroundColor: _TeamsJson2['default'][this.props.away].color }] },
...
exports['default'] = (0, _radium2['default'])(ScoreBox);
